...
static SN76496 ono_sn; // one and only SN76496
int *sn76496_regs;
...
static void SN76496_set_clock(SN76496 *R,int clock)
{
	...
	/* number. */
	R->UpdateStep = ((qreal)STEP * R->SampleRate * 16) / clock;
}


static void SN76496_set_gain(SN76496 *R,int gain)
{
	int i;
	qreal out;
